...
class TabIconData {
  ...
  static List<TabIconData> tabIconsList = <TabIconData>[
    TabIconData(
      imagePath: 'assets/icons/bot-nav/tab_1.png',
      selectedImagePath: 'assets/icons/bot-nav/tab_1s.png',
      index: 0,
      isSelected: true,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/icons/bot-nav/tab_2.png',
      selectedImagePath: 'assets/icons/bot-nav/tab_2s.png',
      index: 1,
      isSelected: false,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/icons/bot-nav/tab_3.png',
      selectedImagePath: 'assets/icons/bot-nav/tab_3s.png',
      index: 2,
      isSelected: false,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/icons/bot-nav/tab_4.png',
      selectedImagePath: 'assets/icons/bot-nav/tab_4s.png',
      index: 3,
      isSelected: false,
      animationController: null,
    ),
