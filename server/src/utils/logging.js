...
const info = (tag, message, object = null) => log('info', tag, message, object);
const warn = (tag, message, object = null) => log('warn', tag, message, object);
const error = (tag, message, object = null) => log('error', tag, message, object);
const debug = (tag, message, object = null) => log('debug', tag, message, object);
